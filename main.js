...
const diagnosisHistoryElement = document.querySelector(".diagnosis-history");
const diagnosisListElement = document.querySelector(".diagnosis-list");
const patientInfoElement = document.querySelector(".patient-info-content");
const labInfoContentElement = document.querySelector(".lab-info-content div");
      ...
      `;
        ...
        `;
            ...
            const bpHistory = jessica.diagnosis_history
                .filter((d) => d.blood_pressure?.systolic?.value &&
